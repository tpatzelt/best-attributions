"""
Functionality for the total proportionality ablation evaluation.
...
https://www.facebook.com/groups/1638968383075904/?multi_permalinks=2690200534619345&notif_id=1638259397597864&notif_t=group_highlights&ref=notif
    ...
    def _get_proportionality_value(self,
        ...
        for (mask_normal, ratio_normal), (mask_reverse, _) in zip(
            ...
            ablated_prediction_reverse = self._ablate_and_predict(mask_reverse, observation,
                                                                  predicted_class)
            proportionality_value = abs(
                ablated_prediction_normal - ablated_prediction_reverse
            )
    ...
    def evaluate(self, observation, attribution_values, saliency_ratio_per_step=.1, **kwargs) -> dict:
